    ...
    public class Sodoku
    {
        ...
        public bool Validate()
        {
            ...
            for (int c = 0; c < 2; c++)
            {
                for(int r = 0; r < 2; r++)
                {
                    if (!GetSodoku3x3At(c, r).Validate()) { return false; }
                }
            }
        ...
        /// <returns></returns>
        public Sodoku3x3 GetSodoku3x3At(int xGrids, int yGrids)
        {
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public Sodoku3x3 GetSodoku3x3AtGridPosition(int x, int y) => GetSodoku3x3At(GridIndexFromItemIndex(x), GridIndexFromItemIndex(y));


        public SodokuItem Sodoku3x3ToItemAt(int xGrids, int yGrids) => GetSodoku3x3At(xGrids, yGrids).ToSodokuItem();
        ...
        public List<int> AvailableRanks(int x, int y)
        {
            ...
            var gridRanks = GetSodoku3x3AtGridPosition(x, y).AvailableRanks();
